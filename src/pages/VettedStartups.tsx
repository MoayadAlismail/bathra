...
const VettedStartups = () => {
  ...
  const [savedStartups, setSavedStartups] = useState<string[]>([]); // Changed to string[]
  ...
  useEffect(() => {
    const fetchStartups = async () => {
      try {
        setIsLoading(true);
        const response = await fetch("https://localhost:7262/api/Startup/getAllStartups");
        ...
        setStartups(data.map((startup: any) => ({
          ...startup,
                ...
                {filteredStartups.map((startup) => (
                  ...
                  >
                    <div 
                      ...
                      style={{ 
                        backgroundImage: `url(${startup.image || 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&auto=format&fit=crop'})`,
